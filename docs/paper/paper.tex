...
\paragraph{Hebbian Emergence}
The most compelling result: Hebbian links form with 100\% within-topic precision. Across 5 co-retrieval sessions for each of 3 topics (ML, cooking, travel), all 6 formed links connected semantically related memories. No cross-topic noise links emerged. This validates that co-activation captures meaningful relationships without NER:
...
Metric & Value \\
\midrule
Total links formed & 6 \\
Within-topic links & 6 \\
Cross-topic (noise) & 0 \\
Precision & 100\% \\
\bottomrule
\end{tabular}
\caption{Hebbian link formation after 5 sessions per topic}
\end{table}
